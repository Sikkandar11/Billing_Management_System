...
public class UpdateBuyer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(update, new org.netbeans.lib.awtextra.AbsoluteConstraints(74, 388, -1, -1));
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        ...
        try {
            Connection Con = ConnectionProvider.getcon();
            Statement Stm = Con.createStatement();
            Stm.executeUpdate("update Buyer set Name='"+Name+"',Contact_no='"+Contact_no+"',Email='"+Email+"',Address='"+Address+"',Gender='"+Gender+"' where Contact_no='"+Contact_No+"'");
