...
public class DeleteProduct extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 370, -1, -1));
     ...
     String Product_ID = txtproductid .getText();
        ...
        if (Delete == 0) {
            try {
                Connection Con = ConnectionProvider.getcon();
                Statement Stm = Con.createStatement();
                Stm.executeUpdate("delete from  Product where Product_ID='" + Product_ID + "'");
